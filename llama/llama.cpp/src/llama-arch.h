...
enum llm_kv {
    ...
    LLM_KV_POOLING_TYPE,
    LLM_KV_POOLING_NORMALIZE_EMBEDDINGS,
    LLM_KV_LOGIT_SCALE,
    ...
    LLM_KV_ATTENTION_GLOBAL_ATTN_EVERY_N_LAYERS,
    LLM_KV_ATTENTION_LOCAL_ATTN_WINDOW,
    ...
    LLM_KV_ROPE_FREQ_BASE_LOCAL,
    LLM_KV_ROPE_FREQ_BASE_GLOBAL,
